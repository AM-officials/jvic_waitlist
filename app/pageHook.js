      ...
      <section className=" mt-5  ">
        <div className="space-y-4 ">
          <div className="space-y-2 text-center">
            ...
            <p className="max-w-[600px]  leading-7 text-center text-[16px] bg-clip-text text-transparent dark:bg-gradient-to-br bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-700 mx-auto pb-10">
              
"Explore a World of Nutritious Delights with JVIC and Get Ready for Exciting New Additions to Our Healthy Food Collection. Join Our Waitlist to be the first to know when we launch!"
            </p>
            {errors.email && (
